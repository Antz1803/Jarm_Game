...
namespace Jarm_Game
{
    public partial class frmMultiplication1 : Form
    {
        Antipaso Design = new Antipaso();
        public frmMultiplication1(string P1, string P2)
        {
            InitializeComponent();
            txtplayer1.Text = P1;
            txtplayer2.Text = P2;
        ...
        int prod;
        clsMultiplication question = new clsMultiplication("", "");
        Random random = new Random();
        public void Question(int ope1, int ope2) // This void has a function that give the random value 
        {
            txtquestion.Text = $"{ope1} x {ope2}?";
        }
        private void frmMultiplication1_Load(object sender, EventArgs e)
        {
        ...
        {
            //Restart the Game
            frmPlayerNameGuest PlayerNames = new frmPlayerNameGuest();
            PlayerNames.Show();
            this.Close();
        }

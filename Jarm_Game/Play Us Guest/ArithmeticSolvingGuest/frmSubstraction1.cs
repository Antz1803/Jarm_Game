...
namespace Jarm_Game
{
    public partial class frmSubstraction1 : Form
    {
        Antipaso Design = new Antipaso();
        public frmSubstraction1(string P1,string P2)
        {
            InitializeComponent();
            txtplayer1.Text = P1;
            txtplayer2.Text = P2;
        ...
        int prod;
        clsSubstraction question = new clsSubstraction("", "");
        Random random = new Random();
        private void frmSubstraction1_Load(object sender, EventArgs e)
        {
